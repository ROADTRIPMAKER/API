...
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        String accessToken = JWT.create().withSubject(mail).withExpiresAt(new Date(System.currentTimeMillis() + 10 * 600 * 1000))
        ...
        String refreshToken = JWT.create().withSubject(mail).withExpiresAt(new Date(System.currentTimeMillis() + 30 * 600 * 1000))
                .withIssuer(request.getRequestURI().toString())
                .sign(algorithm);
